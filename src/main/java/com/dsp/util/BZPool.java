...
System.out.println(name + " pool has " + size + " objects");
	} // checkIn()
	...
	public synchronized Object checkOut()
	{
		...
		while ((size = list.size()) == 0)
			try {
System.out.println(name + " pool has no objects, waiting...");
				wait();
System.out.println(name + " pool is done waiting");
